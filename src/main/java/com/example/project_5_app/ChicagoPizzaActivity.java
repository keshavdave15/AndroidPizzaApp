...
import PizzaPlace.PizzaPlace.ChicagoPizza;
...
/**
 * Activity for selecting and customizing Chicago-style pizzas.
...
public class ChicagoPizzaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chicagopizza_layout);
    ...
    public void onNothingSelected(AdapterView<?> parent) {}
        ...
        homeButton.setOnClickListener(v -> {
            Intent intent = new Intent(ChicagoPizzaActivity.this, MainActivity.class);
    ...
    private void handleToppings(Pizza pizza) {
        ...
        ToppingsAdapter adapter = new ToppingsAdapter(
            ...
            topping -> handlePrice(pizza) // Update price dynamically
        );
    ...
    private void handlePizzaImage(Pizza pizza) {
        ...
        if (pizza instanceof Deluxe) {
            imageResource = R.drawable.chicagodeluxe;
        } else if (pizza instanceof BBQChicken) {
            imageResource = R.drawable.chicagobbqchicken;
        } else if (pizza instanceof Meatzza) {
            imageResource = R.drawable.chicagomeatzza;
